      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-3 hide-scrollbar">
        ...
        {messages.map((msg, i) => (
          <div key={i} className="flex gap-2.5 items-start">
            <div className="shrink-0 w-6 h-6 rounded-md flex items-center justify-between mt-0.5 bg-zinc-50">
              {msg.role === "user" ? (
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[13px] text-zinc-700 leading-tight tracking-wider whitespace-pre-wrap wrap-break-word">
