        ...
        <div className="w-full max-w-sm">
          <div className="mb-10">
            ...
            <p className="text-sm text-zinc-400">
              {isLogin
                ? "Enter your creditionals to access your website builder."
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              className="w-full py-2.5  bg-purple-700 text-white font-semibold hover:scale-102 disabled:opacity-40 flex items-center justify-center cursor-pointer mt-2 rounded-lg transition-all"
              type="submit"
              disabled={loading}
            >
              {" "}
